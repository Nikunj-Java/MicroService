...
const USERS = {
  alice1: { password: 'mission123', roles: ['MISSION_OPERATOR'] },
  alice2: { password: 'mission123', roles: ['GUEST'] },
  alice3: { password: 'mission123', roles: ['MISSION_ADMIN'] },
  alice4: { password: 'mission123', roles: ['MISSION_VIEW'] },
};
